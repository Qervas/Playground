...
void main(){
    ...
    vec3 vector0 = vec3(gl_in[0].gl_Position) - vec3(gl_in[1].gl_Position);
    vec3 vector1 = vec3(gl_in[2].gl_Position) - vec3(gl_in[1].gl_Position);
    vec4 surfaceNormal = vec4(normalize(cross(vector0, vector1)), 0.0) * 0;
